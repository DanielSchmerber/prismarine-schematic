...
function read (nbt, version) {
    ...
    if(nbt.Schematic.Metadata && nbt.Schematic.Metadata.WorldEdit){
        offset = new Vec3(
            nbt.Schematic.Metadata.WorldEdit.Origin[0],
            nbt.Schematic.Metadata.WorldEdit.Origin[1],
            nbt.Schematic.Metadata.WorldEdit.Origin[2])
    }
